...
RSpec.describe EvaluationItemsController, :type => :controller do

  # This should return the minimal set of attributes required to create a valid
  # EvaluationItem. As you add validations to EvaluationItem, be sure to
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new EvaluationItem" do
        expect {
          post :create, {:evaluation_item => valid_attributes}, valid_session
        }.to change(EvaluationItem, :count).by(1)
      end

      it "assigns a newly created evaluation_item as @evaluation_item" do
        post :create, {:evaluation_item => valid_attributes}, valid_session
        expect(assigns(:evaluation_item)).to be_a(EvaluationItem)
        expect(assigns(:evaluation_item)).to be_persisted
      end

      it "redirects to the created evaluation_item" do
        post :create, {:evaluation_item => valid_attributes}, valid_session
        expect(response).to redirect_to(EvaluationItem.last)
      end
    end
